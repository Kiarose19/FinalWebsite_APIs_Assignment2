...
function GoToDataArtPage(){
    window.location.replace("http://127.0.0.1:5500/data-art.html");
}
...
function GoToDataVisPage(){
    window.location.replace("http://127.0.0.1:5500/data-vis.html");
}
...
function GoToDesignPage(){
    window.location.replace("http://127.0.0.1:5500/designs.html");
}
...
function GoToBlogsPage(){
    window.location.replace("http://127.0.0.1:5501/blogs.html");
}
